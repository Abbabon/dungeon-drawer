...
export const STRINGS: Record<Lang, Strings> = {
  en: {
    ...
    secDifficulty: 'How tricky?',
    secShape: 'Pick a shape',
    secDoors: 'Doors',
    secTreasures: 'Treasures to find',
    secName: 'Name it',
  ...
  he: {
    ...
    secDifficulty: 'כמה קשה?',
    secShape: 'בחרו צורה',
    secDoors: 'דלתות',
    secTreasures: 'אוצרות למצוא',
    secName: 'תנו שם',
  ...
  es: {
    ...
    secDifficulty: '¿Qué tan difícil?',
    secShape: 'Elige una forma',
    secDoors: 'Puertas',
    secTreasures: 'Tesoros por encontrar',
    secName: 'Ponle nombre',
  ...
  fr: {
    ...
    secDifficulty: 'Quelle difficulté ?',
    secShape: 'Choisissez une forme',
    secDoors: 'Portes',
    secTreasures: 'Trésors à trouver',
    secName: 'Donnez-lui un nom',
  ...
  de: {
    ...
    secDifficulty: 'Wie knifflig?',
    secShape: 'Form wählen',
    secDoors: 'Türen',
    secTreasures: 'Schätze zum Finden',
    secName: 'Namen geben',
